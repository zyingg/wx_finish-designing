  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("add_date,category_id,goods_banner_imgs,goods_desc,goods_price,goods_thumb,keywords,last_modify_date,name,remain_count").get().then((res) => {
