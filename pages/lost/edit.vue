  ...
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validate-trigger="submit" err-show-type="toast">
      ...
      <uni-forms-item name="lost_desc" label="详细描述">
        <uni-easyinput placeholder="详细描述" v-model="formData.lost_desc" trim="right"></uni-easyinput>
      </uni-forms-item>
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("category_id,name,keywords,lost_desc,lost_place,contact,lost_thumb,add_date,last_modify_date").get().then((res) => {
