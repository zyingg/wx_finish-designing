<template>
	<view class="uni-container">
		<uni-forms ref="form" :model="formData" validate-trigger="submit" err-show-type="toast">
			...
			<!-- <uni-forms-item name="parent_id" label="出售类别">
				<uni-data-picker v-model="formData.category_id" collection="secondgoods-categories"
					field="parent_id as value "></uni-data-picker>
			</uni-forms-item> -->
        ...
        <uni-easyinput placeholder="商品的唯一货号" v-model="formData.goods_sn" trim="both"></uni-easyinput>
			...
			<uni-forms-item name="goods_banner_imgs" label="详情图片">
				...
				<uni-file-picker
				 v-model="formData.goods_banner_imgs" 
				 fileMediatype="image"
					mode="grid"
				  @success="uploadSuccess"></uni-file-picker>
			</uni-forms-item>
		...
		methods: {
			...
			submitForm(value) {
				...
				return db.collection(dbCollectionName).add(value).then((res) => {
					...
					setTimeout(() => uni.navigateBack("/pages/secondgoods/list"
