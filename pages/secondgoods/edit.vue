  ...
  export default {
   ...
   //       console.log(res);
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("category_id,goods_sn,name,keywords,price,goods_desc,picurl,remain_count,contact,checked,add_date,last_modify_date,seller_note").get().then((res) => {
