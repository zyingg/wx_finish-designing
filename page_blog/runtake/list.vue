<template>
	<view class="home">
			...
			<div>
				...
				<uni-list :border="!waterfall" class="uni-list-item--waterfall">
					...
					<uni-list-item class="uni-list-item--waterfall" title="自定义商品列表" v-for="item in newsArr"
						:key="item._id" :to="'/page_blog/runtake/detail?id='+item._id+'&title='+item.name">
						<!-- 通过header插槽定义列表左侧图片 -->
						<template #header>
							<view class="uni-thumb shop-picture" :class="{ 'shop-picture-column': waterfall }">
								...
								<image  mode="aspectFill" src="https://mp-70bea637-b880-4d22-8bea-1ce8ac441f79.cdn.bspapp.com/cloudstorage/9b0bbba5-b635-4047-9d98-fc5251171d13.png"></image> 
							</view>
						</template>
						<!-- 通过body插槽定义商品布局 -->
						<template #body>
		...
		<view class="nodata" v-if="!newsArr.length">
			<image src="https://mp-70bea637-b880-4d22-8bea-1ce8ac441f79.cdn.bspapp.com/cloudstorage/ae2a3479-90f0-4a68-9f47-0dba7e25fb90.png" mode="widthFix"></image>
