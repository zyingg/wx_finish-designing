	...
	<view class="uni-searchbar">
		<view :style="{borderRadius:radius+'px',backgroundColor: bgColor}" class="uni-searchbar__box"
			...
			<input v-if="show || searchVal" :focus="showSync" :placeholder="placeholderText" :maxlength="maxlength"
				...
				@confirm="confirm" @blur="blur" @focus="emitFocus" @click="clickFn" :disabled="disabled"/>
			<text v-else class="uni-searchbar__text-placeholder">{{ placeholder }}</text>
			<view v-if="show && (clearButton==='always'||clearButton==='auto'&&searchVal!=='')"
				class="uni-searchbar__box-icon-clear" @click.stop="clear">
				<slot name="clearIcon">
					<uni-icons color="#c0c4cc" size="15" type="clear" />
				</slot>
			</view>
		</view>
		<text @click.stop="cancel" class="uni-searchbar__cancel"
